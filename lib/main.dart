...
class STApp extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _STAppState();
}
...
class _STAppState extends State<STApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: STHomePage(),
      theme: generateTheme(dark: false),
      darkTheme: generateTheme(dark: true),
      themeMode: currentTheme.currentMode(),
      debugShowCheckedModeBanner: false,
    );
  }

  ThemeData generateTheme({bool dark}) {
    return ThemeData(
...
class STHomePage extends StatefulWidget {
  STHomePage({Key key}) : super(key: key);
  ...
  final String title = "Switchable Theme Demo Page";

  @override
  _STHomePageState createState() => _STHomePageState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton:
          ...
          FloatingActionButton.extended(
            onPressed: () {
              currentTheme.switchTo("system");
            },
            tooltip: 'Set to system default',
            label: Text("Set to system default"),
